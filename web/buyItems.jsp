            ...
            <div class="grid_16" id="whiteBox" style="padding: 10px;">
                <div class="grid_8">
                    ...
                    <form method="post" action="buyItems">
                        ...
                        <div class="grid_5">
                            <input  type="text" value="Ahmedabad" disabled/> We Do not accept any orders outside Ahmedabad
                        </div>
                        <div class="clear"></div><br/>
                        <div class="grid_5" >
               ...
               if (User.getAddress() != null && User.getMobileNum() != null && User.getUserEmail() != null && User.getUsername() != null){
                   ...
                   <div class="grid_7 shippingAddress" id="useInfo">
                       <h1><strong>Click this Box to add Details or fill the form on the left</strong></h1>
                       <br>
